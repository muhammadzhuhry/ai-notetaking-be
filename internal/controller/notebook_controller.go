...
func (c *notebookController) GetAll(ctx *fiber.Ctx) error {
	...
	return ctx.JSON(serverutils.SuccessResponse("Success retrieved all notebooks", res))
}
...
func (c *notebookController) Create(ctx *fiber.Ctx) error {
	...
	return ctx.JSON(serverutils.SuccessResponse("Success created notebook", res))
}
...
func (c *notebookController) Show(ctx *fiber.Ctx) error {
	...
	return ctx.JSON(serverutils.SuccessResponse("Success showed notebook", res))
}
...
func (c *notebookController) Delete(ctx *fiber.Ctx) error {
	...
	return ctx.JSON(serverutils.SuccessResponse[any]("Success deleted notebook", nil))
}
...
func (c *notebookController) MoveNotebook(ctx *fiber.Ctx) error {
	...
	return ctx.JSON(serverutils.SuccessResponse("Success moved notebook", res))
}
